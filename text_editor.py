...
def mainWindow():
    ...
    # Add Speech menu
    speech_menu = Menu(my_menu, tearoff=False)
    my_menu.add_cascade(label="Speech", menu=speech_menu)
    ...
    bold_button = Button(toolbar_frame,text="B", command=bold_it,compound=CENTER,font=("Helvetica", 10,"bold"),)
    bold_button.grid(row=0, column=0, sticky=W, padx=5, pady=5)
    # Italics Button
    italics_button = Button(toolbar_frame,text="I", command=italics_it,font=("Helvetica", 10,"bold"),)
    italics_button.grid(row=0, column=1, padx=5, pady=5)

    # Undo/Redo Buttons
    undo_button = Button(toolbar_frame, text="Undo", command=my_text.edit_undo,font=("Helvetica", 10,"bold"),)
    undo_button.grid(row=0, column=2, padx=5, pady=5)
    redo_button = Button(toolbar_frame, text="Redo", command=my_text.edit_redo,font=("Helvetica", 10,"bold"),)
    ...
    theme_button.grid(row=0,column=5)
